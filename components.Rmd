...
3. You can provide short text annotations for the various charts within a dashboard by including blockquoted text (i.e. text prefixed with `>`) immediately below the R code chunk where the chart is rendered.
