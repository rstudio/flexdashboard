...
2. shinydashboard components have more explicit sizes so are better suited to presenting standard R graphics and textual output.
...
3. flexdashboard can create standalone web dashboards (requiring no Shiny Server) if they are restricted to just presenting static data rather than allowing the user to vary assumptions and parameters or observing changes in real-time.
