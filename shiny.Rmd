...
Here's the source code for the example. Note that since we have only a single chart as output we definitely want it to fill all of the available space. To accomplish this we specify `vertical_layout: fill` to the output options.
