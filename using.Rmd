...
You should also include a `url` as the navigation target. Note that a URL can be automatically generated for social sharing links (i.e. when you use the "fa-facebook", "fa-twitter", "fa-google-plus", "fa-linkedin", or "fa-pinterest" icon).
