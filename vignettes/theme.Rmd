...
You can quickly change the fonts in your `flex_dashboard` using functions from the [sass package](https://rstudio.github.io/sass/index.html). For now, you'll need to install the development version of the sass package:
