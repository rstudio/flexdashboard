...
We recommend you set the Bootstrap version in your YAML for better reproducibility.

This screenshot shows the result of applying the above `theme` to [this example dashboard](https://gist.github.com/cpsievert/04bedbe9af652fab8c24a5e5eee0d721) that [uses Shiny](theme.html) (subsequent screenshots also use this example, but swap out different `theme`s).
