...
You can optionally provide icons for the navigation bar menus by including the `data-navmenu-icon` attribute when you first assign a page to a navigation bar menu.
