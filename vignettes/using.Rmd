...
In fact, the tabset examples above use two examples of header attributes:
```
Column {.tabset}
-------------------------------------
```
...
In the final HTML, the CSS classes `tabset` and `tabset tabset-fade` are added to the sections defined by the Column and Row headings.
